...
![fork](C:/Users/timoi/OneDrive - University of Helsinki/ZilanWen Github/RNA-seq_Differential-Gene-Expression-Analysis/image/Github5.png){width=50%}

## 2.1  How to create a Github pages site?

The instruction about [creating a GitHub pages site](https://docs.github.com/en/pages/getting-started-with-github-pages/creating-a-github-pages-site#creating-a-repository-for-your-site)

* 1. If you want to create a site in an existing repository
In the upper-right corner of any page, select ´+´, then click `New repository`.
![createNewrepp](C:/Users/timoi/OneDrive - University of Helsinki/ZilanWen Github/RNA-seq_Differential-Gene-Expression-Analysis/image/Github6.png){width=50%}
...
![user](C:/Users/timoi/OneDrive - University of Helsinki/ZilanWen Github/RNA-seq_Differential-Gene-Expression-Analysis/image/Github7.png){width=50%}
...
* 5 Under your repository name, click  `Settings`--> click `Pages` in the "Code and automation" section --> Click `Visit site ` to see your publish site
    ...
    But you can't find the site now, It can take up to 10 minutes for changes to your site to publish after you push the changes to GitHub.  \
![nopageyet](C:/Users/timoi/OneDrive - University of Helsinki/ZilanWen Github/RNA-seq_Differential-Gene-Expression-Analysis/image/Github8.png){width=50%}
...
![connect](C:/Users/timoi/OneDrive - University of Helsinki/ZilanWen Github/RNA-seq_Differential-Gene-Expression-Analysis/image/Github2.png){width=50%}

* 9 **Upload `data`, `results` files in the local path of your repository** 

* 10 **Push local files to GitHub cloud** Any changes and updated files can be uploaded to GitHUb cloud though GitHub Desktop.Atfter change files, go back to GitHub Desktop and navigate the corresponding repository, you will have the changes listed on the top left. We now give the change a title such as '11' in the`summary (required)`box and click `Commit to main` on the bottom left, Then on the right, we can push comments to the origin remote by clicking `Push origin`.\
![push](C:/Users/timoi/OneDrive - University of Helsinki/ZilanWen Github/RNA-seq_Differential-Gene-Expression-Analysis/image/Github3.png){width=80%}
...
![pagevisible](C:/Users/timoi/OneDrive - University of Helsinki/ZilanWen Github/RNA-seq_Differential-Gene-Expression-Analysis/image/Github9.png){width=50%}



    *If you want to create a site in an existing repository, you can rename the respositoty as `username.github.io`*

* 12. The page generated by knit to HTML is not visible If we click to visit site, it would be like this:

![pagecontent](C:/Users/timoi/OneDrive - University of Helsinki/ZilanWen Github/RNA-seq_Differential-Gene-Expression-Analysis/image/Github10.png){width=15%}
...
![content](C:/Users/timoi/OneDrive - University of Helsinki/ZilanWen Github/RNA-seq_Differential-Gene-Expression-Analysis/image/Github11.png)
...
A: The preferred formats is to push all the files into github cloud as public repository and create a github page site which links to your `knit to html file` from R markdown.  All the files in your repository include `results`, `data`,  R markdown file named `index.rmd`, the html file named `index.html`.\
![github files](C:/Users/timoi/OneDrive - University of Helsinki/ZilanWen Github/RNA-seq_Differential-Gene-Expression-Analysis/image/Github12.png){width=70%}

Q: Is there also an option to turn in the R scripts and associated plots?

A: If you don't feel like to github, you can also have the option that  package R scripts `.r` file or R markdown file `.rmd` + results together and sent email to `zilan.wen@helsinki.fi`.
...
7. show the count distrbution. The file named 'count distribution.png'

8. MDS plot generated from EdgeR, The file named 'plotMDS.Infection.png'

9. plotPCA to show the sample similarity. the file named such as PlotPCA_dds.pdf

10. heatmap to show the sample cluster, the file named such as PlotHeatmap_dds.pdf

11. show the differentially expressed gene in the plots named 'plotSmear.InfectionRNAseq.png'

The results list like below:\

![results list](C:/Users/timoi/OneDrive - University of Helsinki/ZilanWen Github/RNA-seq_Differential-Gene-Expression-Analysis/image/Github13.png){width=30%}
...
The things to be demonstrated: Learning about the count normalization, sample-level quality control by PCA, selecting differentially expressed genes. Building up the github system is recommended and optional, it is a useful tool which is popular to use in recent years. It can save the whole process in the repository of github cloud, and convenient to recover the knowledge long period time later.

Q: What is the deadline for the submission of this assignment?
 
I suggest to try to finish it on the course on Thursday morning.  if you need more time, we can sure extend one or two weeks if you need.
