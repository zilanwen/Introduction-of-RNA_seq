...
*  10 **Github page link could be visible now**. Go to GitHub  website --> the setting --> Pages. You can now find the link of the Github page

![9](C:/Users/timoi/OneDrive - University of Helsinki/ZilanWen Github/RNA-seq_Differential-Gene-Expression-Analysis/image/Github9.png){width=50%}
