...
1.Go to the `File` menu and select `New Project`.2.In the `New Project` window, choose `New Directory`. Then, choose `New Project`. Name your new directory `RNA_seq_DEA` and then "Create the project as subdirectory of:" the Desktop or `OneDrive - University of Helsinki` (or location of your choice).3.The new project should automatically open in RStudio.\
